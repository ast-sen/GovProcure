...
export const ObligationSlipFormHeader: React.FC<ObligationSlipFormHeaderProps> = ({ 
  ...
  return (
    <div>
      <div className={`border-b-2 ${darkMode ? 'border-gray-600' : 'border-gray-800'} p-6`}>
        <div className="flex items-start gap-6 mb-6">
          ...
          <div className="flex-1 text-center">
            ...
            <h1 className={`text-3xl font-bold ${styles.textPrimary} mt-4`}>OBLIGATION SLIP</h1>
            <p className={`text-sm ${styles.textSecondary} mt-2`}>Page 1 of 1</p>
          </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            <label className={`block text-sm font-medium ${styles.textPrimary} mb-1`}>No.:</label>
            <input
              type="text"
              value={formData.no}
          ...
          <div>
            <label className={`block text-sm font-medium ${styles.textPrimary} mb-1`}>Date:</label>
            <input
              type="date"
              value={formData.date}
      ...
      <div className={`p-6 ${darkMode ? 'bg-gray-700' : 'bg-gray-50'} border-b ${styles.border}`}>
        <div className="grid gap-4">
          <div>
            <label className={`block text-sm font-bold ${styles.textPrimary} mb-1`}>Payee/Office:</label>
            <input
              type="text"
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className={`block text-sm font-bold ${styles.textPrimary} mb-1`}>Responsibility Center:</label>
              <input
                type="text"
            ...
            <div>
              <label className={`block text-sm font-bold ${styles.textPrimary} mb-1`}>F/P.P.A:</label>
              <input
                type="text"
                value={formData.fppa}
