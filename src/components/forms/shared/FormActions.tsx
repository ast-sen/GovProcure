        ...
        {showDropdown && (
          <div className="absolute right-0 mt-2 w-56 bg-white rounded-lg shadow-xl border border-gray-200 z-50 overflow-hidden">
            <button
              ...
              className="w-full px-4 py-3 text-left hover:bg-blue-50 transition-colors flex items-start gap-3 border-b border-gray-100"
            >
              <Save size={18} className="text-blue-600 mt-0.5 flex-shrink-0" />
              <div>
                <div className="font-semibold text-gray-900">Save as Draft</div>
                <div className="text-xs text-gray-500 mt-0.5">Save without submitting</div>
              </div>
            </button>
            ...
            >
              ...
              <div>
                <div className="font-semibold text-gray-900">Submit for Approval</div>
                <div className="text-xs text-gray-500 mt-0.5">Send to approver</div>
              </div>
            </button>
          </div>
        )}
