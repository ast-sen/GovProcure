...
export const POPreviewModal: React.FC<POPreviewModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4 no-print">
      <div className={`${styles.bgCard} rounded-lg shadow-2xl w-full max-w-6xl max-h-[90vh] flex flex-col border ${styles.border}`}>
        <div className={`flex items-center justify-between p-4 border-b ${styles.border}`}>
          <h2 className={`text-xl font-bold ${styles.textPrimary}`}>Preview Purchase Order (Letter Landscape)</h2>
